...
class Package {
    ...
    public:
        ...
        void setOrderNumber(int orderNumber) {
            if(orderNumber > 0) {
                ...
                throw invalid_argument("Exception in Package: orderNumber must be positive");
            }
        }
    ...
    public:
        ...
        string toString() {
            stringstream pp;
            pp << setw(5) << setfill('0') << getOrderNumber() << getWeight() << getFrom() << getTo();
            return pp.str();
        }
};
...
int main() {
    try{
        ...
        // Test 4
        {
            ...
            int id1 = p41.getId();
            Package p42("Lithuania", "Australia", 2);
            int id2 = p42.getId();
            Package p43("Lithuania", "Latvia", 4);
            int id3 = p43.getId();
    ...
    cout << "Left objects: " << Package::getObjectCount() << endl;
